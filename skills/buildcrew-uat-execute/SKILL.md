...
```json
{
  "phase": "uat-execute",
  "verdict": "pass",
  "details": "All N scenarios passed"
}
```

**If one or more scenarios failed:**
```json
{
  "phase": "uat-execute",
  "verdict": "fail",
  "details": "N of M scenarios failed: [brief list of failing scenario names]"
}
```

**If scenarios errored (environmental/harness issues):**
```json
{
  "phase": "uat-execute",
  "verdict": "error",
  "details": "N scenarios errored: [brief description of environmental issue]"
}
```

**If scenarios had ambiguous results:**
```json
{
  "phase": "uat-execute",
  "verdict": "disputed",
  "details": "N scenarios disputed: [brief description of ambiguity]"
}
```

**Verdict precedence** (if mixed results): `fail` > `error` > `disputed` > `pass`. Use the highest-precedence status as the overall verdict.
