...
**If harness was built successfully:**
```json
{
  "phase": "uat-harness",
  "verdict": "pass",
  "details": "Built test harness with N scenario tests covering M feature areas"
}
```

**If interface type cannot be determined:**
```json
{
  "phase": "uat-harness",
  "verdict": "fail",
  "details": "Cannot determine interface type from README: [reason]"
}
```

**If interface is ambiguous:**
```json
{
  "phase": "uat-harness",
  "verdict": "disputed",
  "details": "Ambiguous interface in README: [description of ambiguity]. Cannot determine whether to build CLI, API, or library tests."
}
```
