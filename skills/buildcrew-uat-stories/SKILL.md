...
**If stories were extracted successfully:**
```json
{
  "phase": "uat-stories",
  "verdict": "pass",
  "details": "Extracted N user stories across M feature areas from README"
}
```

**If README is too vague to extract stories:**
```json
{
  "phase": "uat-stories",
  "verdict": "fail",
  "details": "README too vague to extract actionable user stories: [reason]"
}
```
