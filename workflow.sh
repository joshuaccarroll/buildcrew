...
#
# Usage:
#   ./workflow.sh              # Run in foreground (visible terminal)
#   ./workflow.sh --dry-run    # Show what would be done without executing
#   ./workflow.sh --single     # Process only one task then exit
#
# Prerequisites:
